...
def main():
    ...
    if generated_qwen_files:
        ...
        basename = os.path.basename(mp4_path)  # ej: "2026_06_19_13_36_15_405566.mp4"
        timestamp = basename.replace(".mp4", "")  # ej: "2026_06_19_13_36_15_405566"
        excel_output_name = f"output_{timestamp}.xlsx"
        ...
        output_excel = generate_excel_from_multiple_txt(
            ...
            url_list=urls,
            output_excel_name=excel_output_name
        )
